...
class ApiPostgresIntegrationTestCase(unittest.TestCase):
    ...
    def test_post_movimentacoes_idempotencia_conflito_payload(self) -> None:
        ...
        error_payload = response_2.json()
        self.assertEqual("idempotency_payload_conflict", error_payload["code"])
        self.assertEqual("corr_api_pg_mov_idem_002", error_payload["correlation_id"])
